further info: https://docs.aws.amazon.com/codedeploy/latest/userguide/codedeploy-agent-operations-install-ubuntu.html
...
REGISTER AN ON-PREMISE SERVER TO CodeDeploy
