...
# show list of elastic beanstalk commands
eb

# Once successfully deployed, enter the following to view the newly created webpage:
eb open

# provide the status of the eb application
eb status
